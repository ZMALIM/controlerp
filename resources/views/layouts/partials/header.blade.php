		...
		<div class="m-stack m-stack--ver m-stack--desktop">
			...
			-->
												...
												<div class="m-card-user__details">
													<span class="m-card-user__name m--font-weight-500">{{Auth::user()->personal->contacto->razon_social}}</span>
													<a href="" class="m-card-user__email m--font-weight-300 m-link">{{Auth::user()->personal->contacto->email}}</a>
												</div>
											</div>
										</div>
										<div class="m-dropdown__body">
											<div class="m-dropdown__content">
												<ul class="m-nav m-nav--skin-light">
													...
													<li class="m-nav__item">
														<a href="{{ route('logout') }}" class="btn btn-primary m-btn btn-sm btn-block m-btn--custom m-btn--icon m-btn--pill m-btn--air"
